        ...
        switch (interaction.options.getSubcommand()) {
            ...
            case "create":
                ...
                try {
                    ...
                    const photoURL = photo ? await DiriceClient.uploadPhoto("campaigns", photo, `U${interaction.user.id}_CAMP${newCampaign.getID()}.${photo?.name?photo.name.split(".").pop():`${predictExtensionBasedOnContentType(photo.contentType!)}`}`, photo.contentType!) : null;
